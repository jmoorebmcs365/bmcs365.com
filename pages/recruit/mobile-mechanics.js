...
export default function MobileMechanics() {
  return (<>
    <Head>
      <title>Mobile Mechanics – B&M Commercial Services</title>
      <meta name="description" content="Mobile Mechanics jobs in Hillsborough County" />
    </Head>
    <header className="hero">
      <div className="kicker">Fleet & Equipment Support</div>
    ...
    <main>
      <section className="section card">
        <h2>What You Get</h2>
        <ul>
          <li>On‑site diagnostics & repair</li><li>Daytime and after‑hours rotations available</li><li>Steady demand across commercial clients</li>
        </ul>
      </section>
      <section id="apply" className="section card">
        <h2>Apply in 60 seconds</h2>
        
<form name="recruit-mobile-mechanics" method="POST" data-netlify="true" netlify-honeypot="bot-field" className="grid" action="/thanks">
  <input type="hidden" name="form-name" value="recruit-mobile-mechanics" />
  <p hidden>
