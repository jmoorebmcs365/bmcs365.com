...
export default function RehabRestoration() {
  return (<>
    <Head>
      <title>Rehab & Restoration Pros – B&M Commercial Services</title>
      <meta name="description" content="Rehab & Restoration Pros jobs in Hillsborough County" />
    </Head>
    <header className="hero">
      <div className="kicker">Rapid Response Vendor Team</div>
      <h1>Rehab & Restoration Pros</h1>
    ...
    <main>
      <section className="section card">
        <h2>What You Get</h2>
        <ul>
          <li>Make‑readies, turns, disaster clean‑up</li><li>Water/fire remediation partners welcome</li><li>Jobs matched to your crew size & skill</li>
        </ul>
      </section>
      <section id="apply" className="section card">
        <h2>Apply in 60 seconds</h2>
        
<form name="recruit-rehab-restoration" method="POST" data-netlify="true" netlify-honeypot="bot-field" className="grid" action="/thanks">
  <input type="hidden" name="form-name" value="recruit-rehab-restoration" />
  <p hidden>
